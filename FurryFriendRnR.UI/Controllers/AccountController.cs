    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    UserManager.AddToRole(user.Id, "Family");
                    ...
                    newUserDeets.Address = "NA";
                    newUserDeets.City = "NA";
                    newUserDeets.State = "NA";
                    newUserDeets.ZipCode = "12345";
                    newUserDeets.PhoneNumber = "1234567890";

                    FurryFriendRnREntities db = new FurryFriendRnREntities();
